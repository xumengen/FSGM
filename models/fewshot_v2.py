...
class FewShotSeg(nn.Module):
    ...
    def forward(self, supp_imgs, qry_imgs):
        ...
        supp_fts = supp_fts.reshape([-1, channel_size, fts_size[0], fts_size[1]])
        qry_fts = qry_fts.reshape([-1, channel_size, fts_size[0], fts_size[1]])
